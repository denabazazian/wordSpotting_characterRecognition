...
# python PHOCLocalizationTNT.py /home/fcn/wordSpotting/icdarCh4_val_fcnEp113/img_*.mat
...
if __name__=='__main__':
    ...
    for debugingMode in range(0,1):
        ...
        mat_name = '/home/fcn/wordSpotting/icdarCh4_val_fcnEp113/img_873.mat'         
        print mat_name
        ...
        with open(textRes, "w") as res_file:  
            ...
            for nqw in range(0,numQWords): 
                ...
                if (len(voc[nqw])>0 and voc[nqw].split(',')[-1].strip()!='###'):
                   ...
                   cv2.imwrite('/home/fcn/wordSpotting/PHOC_icdarCh4_results_Localization_fcnEp113_TNT/'+fileName+'.png',img)
                   #"""
                   #print subIOU
    ...
    resTot = open("/home/fcn/wordSpotting/PHOC_icdarCh4_results_Localization_fcnEp113_TNT/totalIoU.txt", "w")
