...
# -*- coding: utf-8 -*-
"""
#dena@CVC216:~/Projects/CharacterDetection/quantetiveResults$ 
#python testQuantetiveLocalizationTNT.py /home/fcn/wordSpotting/icdarCh4_val_fcnEp63/img_???.mat

Created on Tue Dec 13 11:33:43 2016
...
# python testQuantetiveLocalizationTNT.py /home/fcn/wordSpotting/icdarCh4_val_fcnEp63/img_*.mat
# python testQuantetiveLocalizationTNT.py /home/fcn/wordSpotting/icdarCh4_val_fcnEp113/img_*.mat
...
if __name__=='__main__':
    ...
    for mat_name in sys.argv[1:]:
        ...
        textRes = '/home/fcn/wordSpotting/icdarCh4_results_Localization_fcnEp113_TNT/'+fileName+'.res.txt'
        ...
        with open(textRes, "w") as res_file:  
            ...
            for nqw in range(0,numQWords): 
                ...
                if (len(voc[nqw])>0 and voc[nqw].split(',')[-1].strip()!='###'):
                   ...
                   cv2.imwrite('/home/fcn/wordSpotting/icdarCh4_results_Localization_fcnEp113_TNT/'+fileName+'.png',img)
                   #"""
                   #print subIOU
