# -*- coding: utf-8 -*-
"""
Created on Thu Jan 26 16:39:53 2017
...
# python /home/dena/Projects/CharacterDetection/quantetiveResults/ConfTPlocalizationPHOCtnt.py /home/fcn/wordSpotting/icdarCh4_val_fcnEp63/img_*.mat
...
# python ConfTPlocalizationPHOCtnt.py /home/fcn/wordSpotting/icdarCh4_val_fcnEp113/img_*.mat
...
############################### HOC2 #########################################################################  
    ...
    #resLTRBInter[:,4]= (BB[:,-1]) * (HistIntersection[:,0])
...
if __name__=='__main__':
    ...
    ConfIoU = open('/home/fcn/wordSpotting/PHOC_TNT_ConfTP_fcnEp113/ConfIoU.txt', 'w')
    for mat_name in sys.argv[1:]:
        ...
        textRes = '/home/fcn/wordSpotting/PHOC_TNT_ConfTP_fcnEp113/'+fileName+'.res.txt'
        ...
        with open(textRes, "w") as res_file:  
            ...
            for nqw in range(0,numQWords): 
                ...
                if (len(voc[nqw])>0 and voc[nqw].split(',')[-1].strip()!='###'):
                   ...
                   subIOU[0][nqw] = IoU
                   #iou_file.write("%f\n"%IoU)                   
                   res_file.write("%d,%d,%d,%d,%d,%d,%d,%d,%s,%f,%f\n" % (l,t,r,t,r,b,l,b,qword,IoU,res[idx[-1],4]))                    
                   ...
                   #cv2.imwrite('/home/fcn/wordSpotting/PHOC_TNT_ConfTP_fcnEp113/'+fileName+'.png',img)
                   #"""
                   #print subIOU
    ...
    resTot = open("/home/fcn/wordSpotting/PHOC_TNT_ConfTP_fcnEp113/totalIoU.txt", "w")
