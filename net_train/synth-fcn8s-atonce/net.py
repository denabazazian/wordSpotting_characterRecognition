...
def fcn(split):
    ...
    pydata_params = dict(split=split, mean=(104.00699, 116.66877, 122.67892),
            seed=1337)
    if split == 'train':
        pydata_params['synthtext_dir'] = '/home/dena/datasets/synthtext'
        pylayer = 'SYNTHTEXTDataLayer'
    else:
        pydata_params['synthtext_dir'] = '/home/dena/datasets/synthtext'
        pylayer = 'SYNTHTEXTDataLayer'
    n.data, n.label = L.Python(module='synthtext_dir', layer=pylayer,
    ...
    n.score_fr = L.Convolution(n.drop7, num_output=38, kernel_size=1, pad=0,
        param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
    n.upscore2 = L.Deconvolution(n.score_fr,
        convolution_param=dict(num_output=38, kernel_size=4, stride=2,
            bias_term=False),
    ...
    n.score_pool4 = L.Convolution(n.scale_pool4, num_output=38, kernel_size=1, pad=0,
        param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
    ...
    n.score_pool3 = L.Convolution(n.scale_pool3, num_output=38, kernel_size=1, pad=0,
        param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
    ...
    n.upscore8 = L.Deconvolution(n.fuse_pool3,
        convolution_param=dict(num_output=38, kernel_size=16, stride=8,
            bias_term=False),
        param=[dict(lr_mult=0)])
